# AGENTS.md — sample (Go tier skeleton)

Agent guidance for this tool. Contract harness: `../verify-cli`; stack: cobra v1.10.2 + fang v2.0.1 + go-pretty v6.8.3 (DECISIONS rows E-F).
...
- Keep `emit` the single rendering path; contract flags live on `root.PersistentFlags()` so they
