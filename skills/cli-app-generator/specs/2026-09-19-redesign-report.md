...
| fetchone | python-single-file / human | 8.44 s  | 9 | 20,274 B (5 files) | 10/0/1 skip (check 8: no completion machinery, by design) |
...
Ledger at `CHANGES.md` — 55 entries (59 lines) in the standard `- <what> → <replacement|deleted> : <why>`
...
| 5 | Every removal/replacement → one CHANGES.md line | ✅ 55 entries; no unexplained removal found (each deletion cites a DECISIONS row / spec § / ruling) | §3, CHANGES.md |
