...
def run(keys, out):
    ...
    pid, fd = pty.fork()
    if pid == 0:
        os.execvp("env", ["env","HOME=/tmp/spikehome","TERM=xterm-256color","PATH=/home/bs/projects/personal/ynsr-skills/.worktrees/cli-app-generator-v2/skills/cli-app-generator/specs/spikes/b-completion/bin:/home/linuxbrew/.linuxbrew/bin:/usr/local/bin:/usr/bin:/bin","SPIKE_ITEMS_DIR=/tmp/spikehome/.config/spike-items","fish"])
...
run(keys, "fish_screens.txt")
print(open("fish_screens.txt").read())
