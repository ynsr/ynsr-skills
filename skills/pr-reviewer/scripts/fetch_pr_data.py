...
Example:
    ...
    python fetch_pr_data.py https://github.com/owner/repo/pull/123 --output-dir /tmp/custom  # override example

Default output: ~/dev/PRs/<repo>/<PR-NUMBER>/ (override with --output-dir).
"""
...
from review_platform import default_reviews_base
...
def setup_pr_review_dir(base_dir: str, repo: str, pr_number: str) -> Path:
    ...
    pr_review_dir = Path(base_dir).expanduser() / 'PRs' / repo / pr_number
